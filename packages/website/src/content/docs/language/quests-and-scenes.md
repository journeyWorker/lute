...
*(From [`docs/examples/quest-grove.lute`](https://github.com/org/lute/blob/main/docs/examples/quest-grove.lute).)*
...
[`docs/examples/quest-rescue-halsin.lute`](https://github.com/org/lute/blob/main/docs/examples/quest-rescue-halsin.lute).
