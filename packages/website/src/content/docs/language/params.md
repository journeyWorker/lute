...
*(From [`docs/examples/showcase/schema/base.schema.yaml`](https://github.com/org/lute/blob/main/docs/examples/showcase/schema/base.schema.yaml).)*
...
*(Call site from [`docs/examples/showcase/episode01.lute`](https://github.com/org/lute/blob/main/docs/examples/showcase/episode01.lute); a minimal parameterized def is in [`docs/examples/param-def.lute`](https://github.com/org/lute/blob/main/docs/examples/param-def.lute).)*
