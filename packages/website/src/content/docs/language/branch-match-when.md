...
*(From [`docs/examples/marina-s01ep02.lute`](https://github.com/org/lute/blob/main/docs/examples/marina-s01ep02.lute).)*
...
*(From [`docs/examples/showcase/when-is-demo.lute`](https://github.com/org/lute/blob/main/docs/examples/showcase/when-is-demo.lute).)*
...
*(From [`docs/examples/gated-line.lute`](https://github.com/org/lute/blob/main/docs/examples/gated-line.lute).)*
