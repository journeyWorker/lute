...
| Theme | Hybrid: upstream/instrument identity + VN dialogue demo accents |
...
- Launcher: `cargo build --release` then `bun packages/cli/src/index.ts check docs/examples/marina-s01ep02.lute`
