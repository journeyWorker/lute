...
- **Reference (old, superseded):** the upstream TS compiler
  (`packages/lute-core/…/inline/{parser,generator}.ts` → `StoryScript[]` = `arcia_script_commands`).
  Consulted for the *lowering approach* + the row-addressing/`next`-linking convention; its
  all-string product-table schema is **not** the target.
...
- **D1 — New typed JSON IR** *(user)*. Not the legacy all-string `arcia_script_commands`. A
...
```jsonc
{
  ...
  "meta": { "character": "marina", "season": 1, "episode": 2,
            "episodeId": "S01EP02", "title": "Behold the Performance of All-Purpose Marina" },
  "state": [                             // RESOLVED + FOLDED schema (D6), not author-only
    { "path": "scene.affect.marina",  "type": "number", "default": 0 },
...
```jsonc
[
  { "kind":"sprite", "addr":"002-0100", "character":"marina", "anchor":"center", "action":"fade-in-up" },
  { "kind":"sprite", "addr":"002-0200", "character":"marina", "preload":true, "emotion":"surprised",
    "provenance":{ "injected":true, "by":"entry-emotion-lookahead",
      "reason":"pre-loading marina's first emotion `surprised` seen ahead of the entrance" } },
  { "kind":"camera", "addr":"002-0300", "focus":"marina", "zoom":1.1, "duration":0.5, "wait":false },
  { "kind":"line", "addr":"002-0400", "role":"narration", "speaker":"narrator",
    "text":"A hostess walked over with a menu pressed to her chest.",
    "lineId":"marina.s01ep02.narrator_0010" },
  { "kind":"line", "addr":"002-0500", "role":"dialogue", "speaker":"marina",
    "emotion":"surprised", "variant":0, "text":"Oh!",
    "lineId":"marina.s01ep02.marina_0010", "voiceKey":"marina-0010" }
]
```
...
[
  { "kind":"choice", "addr":"004-0500", "branchId":"number", "recordKey":"scene.choices.number",
    "options":[ { "id":"blunt", "label":"Just ask, flatly", "lineId":"marina.s01ep02.number.blunt", "target":"004-0600" },
                { "id":"soft",  "label":"Ask gently",       "lineId":"marina.s01ep02.number.soft",  "target":"004-0800" } ],
    "converge":"004-1100" },
  { "kind":"line", "addr":"004-0600", "role":"dialogue", "speaker":"fixer", "text":"Marina. Your number.",
    "lineId":"marina.s01ep02.fixer_0050", "voiceKey":"fixer-0050" },
  { "kind":"jump", "addr":"004-0700", "target":"004-1100" },                       // end of `blunt`
  { "kind":"line", "addr":"004-0800", "role":"dialogue", "speaker":"fixer",
    "text":"Marina — would you mind terribly if I had your number?", "lineId":"marina.s01ep02.fixer_0052", "voiceKey":"fixer-0052" },
  { "kind":"set",  "addr":"004-0900", "path":"scene.affect.marina", "op":"+=", "value":"1" },
...
{ "kind":"match", "addr":"005-0700", "subject":"scene.choices.number",
  "arms":[ { "test":"(scene.affect.marina >= 1)", "target":"005-0800" },
...
- **Injection goldens** (arch #10): the four rules' separate `sprite` records + provenance, incl. a
  **branch fork/join** case (arm 1 shows marina, arm 2 speaks marina → arm 2 still gets its own
  show/anchor/preload).
- **E2E goldens**: `marina-s01ep02`, `showcase/`, `components/` → full-artifact snapshots
  (`cargo-insta`).
...
{ "kind":"hub", "addr":"006-0100", "id":"barConvo",
  ...
  "options":[
    { "id":"askName", "label":"What's your name?", "lineId":"marina.s01ep02.barConvo.askName",
      "once":true,  "exit":false, "when":"isSet(scene.flags.curious)", "target":"006-0200" },
    { "id":"leave",   "label":"That's enough.",     "lineId":"marina.s01ep02.barConvo.leave",
...
```jsonc
{ "kind":"line", "addr":"007-0100", "role":"dialogue", "speaker":"marina",
  "text":"Nice to meet you, {{userName}} — affection {{scene.affect.marina}}.",
  "lineId":"marina.s01ep02.marina_0080", "voiceKey":"marina-0080",
  "placeholders":[ { "kind":"reserved", "token":"userName" },
                   { "kind":"path", "path":"scene.affect.marina" } ] }
```
...
- **`episodeId` normalization** — `meta.episodeId` MUST equal the lineId episode segment
  ...
  `meta.episodeId: "S01EP01"` beside `lineId: "marina.s01ep01.…"` — a defect to fix in the 0.1.0
  cutover.
