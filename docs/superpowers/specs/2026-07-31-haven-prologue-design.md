...
language's rough edges surface. The Stage adoption assessment drove the whole of 0.9.0. Findings
from writing this are a first-class deliverable, not a byproduct.

## Premise

The generation ship *Haven*, 300 years into a 900-year voyage, is shedding modules to survive. The
...
a scene with `character: haven, season: 1, episode: 3` and `@vesna{code="0040"}` compiles to
`lineId: haven.s01ep03.vesna_0040`, `voiceKey: vesna-0040`.
