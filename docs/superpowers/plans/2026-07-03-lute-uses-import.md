...
- [ ] **Step 3: full gate**
  ...
  - Prior acceptances unchanged: marina exit 0; date-minigame core-only exit 1; `--project` exit 0; arcia-portrait `--project` exit 0. New: `carry-ep.lute` exit 0.
- [ ] **Step 4: commit**
  ```bash
...
- [ ] Acceptances: marina 0 / dm-core 1 / dm-proj 0 / portrait 0 / carry-ep 0.
