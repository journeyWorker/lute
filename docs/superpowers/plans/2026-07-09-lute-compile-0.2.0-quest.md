...
**Files:**
- Modify: `crates/lute-compile/tests/snapshots/*.snap` (the 3 scene e2e goldens: `e2e__marina_s01ep02.snap`, `e2e__components_scene.snap`, `e2e__showcase_episode01.snap`), any ir_golden envelope test.
