...
- [ ] Corpus: `check-project docs/examples/haven` exit 0 unchanged; rewardless artifact byte-diff = version strings only (baseline vs branch, scripted JSON diff).
