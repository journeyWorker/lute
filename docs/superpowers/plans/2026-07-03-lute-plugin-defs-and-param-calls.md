...
./target/debug/lute check docs/examples/marina-s01ep02.lute                                        # exit 0
./target/debug/lute check docs/examples/date-minigame.lute                                         # exit 1 (core-only)
./target/debug/lute check docs/examples/date-minigame.lute --project docs/examples/arcia-project   # exit 0
./target/debug/lute check docs/examples/arcia-portrait.lute --project docs/examples/arcia-project  # exit 0
