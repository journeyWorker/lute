...
- **Attempt** — three probes. (a) `check-project docs/examples` and confirm the
  ...
  scene.
- **Result** —
  (a) `ok: docs/examples/haven/scenes/wake.lute` appears in the outer run; 31
...
- **Verdict** — worked well, and quietly important. Haven can be a
...
identity chain landed exactly on `haven.s01ep01.vesna_0010` first try. The
