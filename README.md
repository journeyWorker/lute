...
repository holds the language design documents extracted from Upstream so the DSL can evolve as its own
project instead of being hidden inside the broader Upstream workspace.
...
- [`docs/examples/arcia-project/date-minigame.lute`](docs/examples/arcia-project/date-minigame.lute) — illustrative plugin-system
...
An excerpt of [`docs/examples/arcia-project/date-minigame.lute`](docs/examples/arcia-project/date-minigame.lute):
...
- **Language: draft.** The grammar is at **0.15.0** — the normative surface is
