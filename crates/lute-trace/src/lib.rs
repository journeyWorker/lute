...
pub use mock::{
    ...
    split_occasion, type_placeholder, validate, validate_bridges, BridgeAnswer, BridgeSpans,
    MockSet, E_MOCK_SUBJECT, E_TRACE_ACCEPT, E_TRACE_BEAT, E_TRACE_CHOICE, E_TRACE_ENTRY,
