...
pub const LUTE_LANG_VERSION: &str = "0.5.1";
...
pub const LUTE_IR_VERSION: &str = "0.5.1";
...
mod tests {
    ...
    fn ir_version_matches_language_version() {
        assert_eq!(super::LUTE_IR_VERSION, "0.5.1");
        assert_eq!(super::LUTE_LANG_VERSION, "0.5.1");
    }
    ...
    fn artifact_emits_relational_schema() {
        ...
        assert_eq!(v["lute"], "0.5.1");
        assert_eq!(v["irVersion"], "0.5.1");
