...
fn envelope_serializes_with_state_entries() {
    ...
    assert_eq!(
        ...
        r#"{"lute":"0.1.0","irVersion":"0.1.0","capabilityVersion":"cap-sha","meta":{"character":"marina","season":1,"episode":2,"episodeId":"s01ep02","title":"T"},"state":[{"path":"scene.choices.number","type":"enum","domain":["blunt","soft","unset"],"provenance":"branch:number"}],"commands":[]}"#
    );
}
