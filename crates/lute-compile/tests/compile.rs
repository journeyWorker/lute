...
fn clean_doc_compiles_with_envelope_expansion_and_ids() {
    ...
    assert_eq!(artifact.lute, "0.20.0");
    assert_eq!(artifact.ir_version, "0.20.0");
...
"#;
    ...
    assert_eq!(actual["lute"], serde_json::json!("0.20.0"));
    assert_eq!(actual["irVersion"], serde_json::json!("0.20.0"));
}
