...
//! bodies, lore Entry bodies, lore bundle Beat bodies), so lint tables and
//! localization tables see the same lines.
//!
...
/// upstream's `emotion+variant` axis and any project's own equivalents).
